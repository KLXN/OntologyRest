...
- w parametrze POST/GET \quotedblbase query\textquotedblright podajemy stworzone zapytanie 
- opcjonalne parametry: output (np. \quotedblbase json\textquotedblright ), default-graph-uri
